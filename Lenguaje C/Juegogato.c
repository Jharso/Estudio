...
void evaluar(void){
    ...
    if((p[1]=='X' && p[2]=='X' && p[3]=='X')||(p[1]=='O' && p[2]=='O' && p[3]=='O')) {    //#1
     ...
     if((p[4]=='X' && p[5]=='X' && p[6]=='X')||(p[4]=='O' && p[5]=='O' && p[6]=='O')) {   //#2

        printf("GANÓ!!!!!!!!!!!  \n");
        g=1;
    }
     if((p[7]=='X' && p[8]=='X' && p[9]=='X')||(p[7]=='O' && p[8]=='O' && p[9]=='O')) {   //#3

        printf("GANÓ!!!!!!!!!!!  \n");
        g=1;
    }
     if((p[1]=='X' && p[4]=='X' && p[7]=='X')||(p[1]=='O' && p[4]=='O' && p[7]=='O')) {   //#4

        printf("GANÓ!!!!!!!!!!!  \n");
        g=1;
    }
     if((p[2]=='X' && p[5]=='X' && p[8]=='X')||(p[2]=='O' && p[5]=='O' && p[8]=='O')) {   //#5

        printf("GANÓ!!!!!!!!!!!  \n");
        g=1;
    }
     if((p[3]=='X' && p[6]=='X' && p[9]=='X')||(p[3]=='O' && p[6]=='O' && p[9]=='O')) {   //#6
 
        printf("GANÓ!!!!!!!!!!!  \n");
        g=1;
    }
     if((p[1]=='X' && p[5]=='X' && p[9]=='X')||(p[1]=='O' && p[5]=='O' && p[9]=='O')) {   //#7

        printf("GANÓ!!!!!!!!!!!  \n");
        g=1;
    }
     if((p[7]=='X' && p[5]=='X' && p[3]=='X')||(p[7]=='O' && p[5]=='O' && p[3]=='O')) {   //#8
